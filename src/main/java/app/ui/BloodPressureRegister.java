 ...
 * @author wmespindula
 */
public class BloodPressureRegister extends javax.swing.JFrame {
     ...
     */
    public BloodPressureRegister(Patient patient, BloodPressureMonitor bloodPressureMonitor) {
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        ...
        BloodPressureObserver bloodPressureObserver = new BloodPressureObserverImpl(patient.getPatientId());
        ObserverManager observerManager = ObserverManager.getInstance();
        observerManager.add((AlertButtonObserverImpl) bloodPressureObserver);

        if (bloodPressureConfig != null) {
            BloodPressureConnector connector = BloodPressureConnector.getInstance();
            connector.attachPatientToMonitor(patient, bloodPressureMonitor.getCode(), bloodPressureObserver,bloodPressureConfig);
        }
