...
public class PatientSearchUI extends javax.swing.JFrame {
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        Long patientId = StringUtils.cpfToLong(cpf);
        if (patientId != null) {
            if (patientAPI.isPatientRegistered(patientId)){
                List<PatientLog> patientLogs = getPatientLogsFromPatientId(dataCenterConnection, patientId);
    ...
    private List<PatientLog> getPatientLogsFromPatientId(DataCenterConnection dataCenterConnection, Long patientId) {
